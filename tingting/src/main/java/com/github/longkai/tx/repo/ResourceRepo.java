...
public interface ResourceRepo extends BaseRepo<Resource> {
	 ...
	 */
	Resource[] myResources(@Param("tid") long teacherId, @Param("offset") int offset, @Param("count") int count);
	 ...
	 */
	Resource[] resourcesFromCourse(@Param("cid") long cid, @Param("offset") int offset, @Param("count") int count);
	 ...
	 */
	Resource[] searchResources(@Param("keywords") String keywords, @Param("offset") int offset, @Param("count") int count);
}
